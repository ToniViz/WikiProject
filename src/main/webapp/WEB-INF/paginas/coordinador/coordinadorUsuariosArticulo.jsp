...
<html>
    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/paginas/coordinador/coordinadorMenu.jsp"></jsp:include>
            ...
            <c:if test="${!empty articulo}">
                <h3>Supervisores del Artículo: ${articulo.tituloArticulo}</h3>
                            ...
                            <tbody>
                                <c:forEach var="usuario" items="${usuarios}" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <a href="${pageContext.request.contextPath}/Controlador?accion=deleteUsuario&usuarioId=${usuario.id}" >
                ...
                <section>
                    ...
                    <c:if test="${!empty candidatos}">
                        <form action="${pageContext.request.contextPath}/Controlador?accion=addUsuarioArticulo"
