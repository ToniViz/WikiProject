    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/paginas/gestor/gestorMenu.jsp"></jsp:include>
            ...
            <main class="contenedor sombra">
                <section>
                    <h3>Wiki: ${wiki.titulo}</h3>
                <form class="formulario" action="${pageContext.request.contextPath}/Controlador?accion=modificarWiki"
                      method="POST">
                    <fieldset>
                        <legend>Modifica los campos necesarios</legend>
                        <div>
                            <div class="campo">
