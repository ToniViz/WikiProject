                ...
                <c:if test="${wikis.size() > 0}">
                    <table class="tabla">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="${pageContext.request.contextPath}/Controlador?accion=modificar&idWiki=${wiki.id}" >
                            ...
                            <td>
                                <div>
                                    <a href="${pageContext.request.contextPath}/Controlador?accion=delete&idWiki=${wiki.id}" >
                            ...
                            <td>
                                <div>
                                    <a href="${pageContext.request.contextPath}/Controlador?accion=gestionarWiki&idWiki=${wiki.id}" >
